...
const statsCards = [
  { value: "21.9%", label: "Child Poverty Rate", sublabel: "41.2% in Campbellton", color: "red" as const },
  { value: "238K+", label: "Without Family Doctor", sublabel: "Nearly 1/3 of NB population", color: "red" as const },
  { value: "$5.9B", label: "NB Power Debt", sublabel: "Rate increases of 50% proposed", color: "neutral" as const },
  { value: "1,500+", label: "Chronically Homeless", sublabel: "100+ deaths in 2025 alone", color: "red" as const },
  { value: "$30B+", label: "Billionaire Wealth", sublabel: "Irving, McCain, Cooke families", color: "neutral" as const },
  { value: "63K+", label: "ER Walkouts/Year", sublabel: "12.9% rate — 3rd highest in Canada", color: "red" as const },
  { value: "$173.9M", label: "Travel Nurse Scandal", sublabel: "Untendered, covered up by courts", color: "neutral" as const },
  { value: "96%", label: "Salmon Collapse", sublabel: "Miramichi River at historic lows", color: "red" as const },
];

const recentEvents = [
  { date: "MAR 14", title: "NB Power Burns 4M Barrels of Oil", category: "ENERGY", description: "Emissions hit 16-year high while utility pitches 'net-zero' premium rate." },
  { date: "MAR 14", title: "Fredericton Chemical Spill", category: "ENVIRONMENT", description: "Cancer-causing chemical coats roads. Government slow to notify." },
  { date: "MAR 14", title: "NB Liquor Markups Strangle Distillers", category: "ECONOMY", description: "Provincial monopoly prevents local producers from scaling up." },
  { date: "MAR 13", title: "$45M 'Industrial Blackmail' Grant", category: "ECONOMY", description: "Holt government subsidizes Irving Paper electricity while cutting education." },
  { date: "MAR 11", title: "Stillborn Lawsuit Settled", category: "HEALTHCARE", description: "Aimee Dunn settles Chalmers ER negligence case after losing pregnancy." },
  { date: "FEB 25", title: "2026 Poverty Report Card", category: "SOCIAL", description: "Campbellton child poverty hits 41.2%. Indigenous reserves: 51.2%." },
];
    ...
    <div className="min-h-screen bg-black text-white selection:bg-crisis-red selection:text-white font-sans">
      ...
      <div className="bg-neutral-900 border-y border-neutral-800 py-4 overflow-hidden relative">
            <div className="flex whitespace-nowrap animate-marquee gap-12 text-[10px] font-black uppercase tracking-[0.3em] text-neutral-500">
              ...
              <span className="text-crisis-red underline italic underline-offset-4">{/* CAMPBELLTON */}41.2%</span>
              ...
              <span className="text-crisis-red underline italic underline-offset-4">{/* ER WALKOUTS */}63K+</span>
              <span>{/* HST */}15% (HIGHEST)</span>
              <span className="text-crisis-red underline italic underline-offset-4">{/* TRAVEL NURSE */}$173.9M</span>
              <span>{/* BILLIONAIRE WEALTH */}$30B+</span>
              <span className="text-crisis-red underline italic underline-offset-4">{/* SALMON COLLAPSE */}96%</span>
              <span>{/* EMISIONS */}3M+ TONNES CO₂</span>
              <span className="text-crisis-red underline italic underline-offset-4">{/* CHILD POVERTY */}21.9%</span>
              <span>{/* WITHOUT DOCTOR */}238K+</span>
              <span className="text-crisis-red underline italic underline-offset-4">{/* CAMPBELLTON */}41.2%</span>
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            <div className="inline-block bg-crisis-red/10 border border-crisis-red/30 px-4 py-2 rounded-full mb-6">
              <span className="text-crisis-red text-[10px] font-black uppercase tracking-[0.4em]">The Data</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-black font-serif text-white uppercase tracking-tighter italic">By The Numbers</h2>
            <p className="text-neutral-500 mt-4 max-w-xl mx-auto">Every statistic is sourced. Every number represents real people failed by a captured system.</p>
          </div>
      ...
      <section className="py-24 bg-black border-b border-neutral-800">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="flex items-center gap-3 mb-12">
            <Calendar className="text-crisis-red" size={24} />
          ...
          <div className="space-y-4">
            {recentEvents.map((event, i) => (
              <div key={i} className="group flex flex-col md:flex-row gap-4 items-start bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-all">
                <div className="shrink-0 flex items-center gap-3">
                  <span className="text-crisis-red font-black text-sm font-mono">{event.date}</span>
                  <span className="text-[10px] font-bold text-neutral-600 uppercase tracking-widest px-2 py-1 bg-black border border-neutral-800 rounded">{event.category}</span>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-white group-hover:text-crisis-red transition-colors mb-1">{event.title}</h3>
                  <p className="text-neutral-500 text-sm italic">{event.description}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-start">
            ...
            <div className="space-y-24">
              ...
              <div className="group border-t border-neutral-900 pt-12">
                <div className="flex items-center gap-4 mb-6">
                  <Home className="text-crisis-red group-hover:scale-110 transition-transform" size={32} />
                ...
                <Link href="/housing" className="text-sm font-black uppercase tracking-[0.3em] text-crisis-red hover:text-white transition-colors flex items-center gap-2 group/link">
                  Open Dossier <ArrowRight size={16} className="group-hover/link:translate-x-2 transition-transform" />
                </Link>
              </div>
